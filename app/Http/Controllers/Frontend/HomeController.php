    ...
    function storeReview(Request $request, Product $product): JsonResponse
    {
        ...
        if (!$productPurchasedByUser) {
            throw ValidationException::withMessages([
                'review' => 'Bạn chưa mua sản phẩm này nên không thể đánh giá.'
            ]);
        }
        ...
        AlertService::created('Đánh giá sản phẩm đã được gửi thành công.');

        return response()->json(['status' => 'success', 'message' => 'Đánh giá sản phẩm đã được gửi thành công.']);
    }
