(function ($) {
    ...
    var leafletBasic = function () {
        if ($('#map-basic').length) {
            ...
            L.tileLayer('https://api.mapbox.com/styles/v1/{id}/tiles/{z}/{x}/{y}?access_token=pk.eyJ1IjoiZHVtbXkiLCJhIjoiZHVtbXkifQ.dummy_mapbox_access_token_placeholder_for_demo', {
                maxZoom: 18,
