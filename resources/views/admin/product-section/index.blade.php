    ...
    <div class="container-xl">
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">Khu vực danh mục sản phẩm (Trang chủ)</h3>
            ...
            <div class="card-body">
                <form action="{{ route('admin.product-sections.store') }}" method="POST" class="coupon-form">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="mb-3">
                                <label class="form-label required">Danh mục Khu vực 1</label>
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                <label class="form-label required">Danh mục Khu vực 2</label>
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                <label class="form-label required">Danh mục Khu vực 3</label>
