    ...
    <div class="container-xl">
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">Thêm liên kết mạng xã hội</h3>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="url" placeholder="https://facebook.com/..." value="">
            ...
            <div class="card-footer text-end">
                <button class="btn btn-primary mt-3" onclick="$('.brand-form').submit()">Tạo liên kết</button>
            </div>
        </div>
    </div>
@endsection
