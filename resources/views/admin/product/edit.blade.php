        ...
        <form action="" class="product-form">
            ...
            <div class="row">
                <div class="col-md-8">
                        ...
                        <div class="card-body">
                            ...
                            <div class="col-md-12">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" name="slug" id="slug" placeholder="duong-dan-san-pham"
                                        value="{{ $product->slug }}">
                                ...
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" name="sku"
                                            value="{{ $product->sku }}" placeholder="VD: SKU-1001">
                                ...
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" name="special_price"
                                            value="{{ $product->special_price }}" placeholder="0.00">
                    ...
                    <div class="card mt-3" id="product-images">
                        ...
                        <div class="card-body">
                            <div class="col-md-12">
                                ...
                                <button class="btn btn-primary mt-3" type="button" id="add-attribute-btn">+ Thêm thuộc tính</button>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card mt-3" id="product-images">
                        <div class="card-header">
                            <h3 class="card-title">Biến thể sản phẩm (Variants)</h3>
                        </div>
                        <div class="card-body">
                            <div class="col-md-12">
                ...
                <div class="col-md-4">
                    <div class="card mb-3">
                        <div class="card-header">
                            <h3 class="card-title">Kiểm duyệt sản phẩm</h3>
                        </div>
                        <div class="card-body">
                            <div class="col-md-12">
                                <div class="mb-3">
                                    <select name="approved_status" class="form-control" id="">
                                        <option @selected($product->approved_status == 'pending') value="pending">Chờ xét duyệt (Pending)</option>
                                        <option @selected($product->approved_status == 'approved') value="approved">Đã duyệt (Approved)</option>
                                        <option @selected($product->approved_status == 'rejected') value="rejected">Từ chối (Rejected)</option>
                                    </select>
                            ...
                            <div class="col-md-12">
                                <div class="mb-3">
                                    <select name="status" class="form-control" id="">
                                        <option @selected($product->status == 'active') value="active">Hoạt động (Active)</option>
                                        <option @selected($product->status == 'inactive') value="inactive">Tạm dừng (Inactive)</option>
                                        <option @selected($product->status == 'draft') value="draft">Bản nháp (Draft)</option>
                                    </select>
                                    <x-input-error :messages="$errors->get('status')" class="mt-2" />
                                </div>
                            </div>
                    ...
                    <div class="card mb-3" style="position: sticky; top: 0;">
                        ...
                        <div class="card-body">
                            <div class="col-md-12">
                                <div class="mb-3 row">
                                    <button class="btn btn-primary mt-3" type="submit">Cập nhật sản phẩm</button>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="accordion-body">
            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <input type="text" class="form-control" value="" name="attribute_name" placeholder="VD: Kích thước, Màu sắc">
                </div>
                <div class="col-md-6">
            ...
            <div class="mt-3">
                <button class="btn btn-sm btn-primary add-row-btn" type="button">+ Thêm dòng</button>
            ...
            $(document).on('click', '.add-row-btn', function() {
                ...
                if (type === 'color') {
                    ...
                    <tr>
                        <td>
                            <input type="text" name="label[]" class="form-control label-input" placeholder="Nhãn màu">
                        </td>
                        <td>
                            <div class="d-flex align-items-center gap-2">
                                ...
                                <span class="review-row-btn ms-2 text-danger cursor-pointer"><i class="ti ti-trash"></i></span>
                            </div>
                    ...
                    <tr>
                        <td colspan="2">
                            <div class="d-flex justify-content-between align-items-center">
                                <input type="text" class="form-control label-input" name="label[]" placeholder="Nhập giá trị">
                                <span class="review-row-btn ms-2 text-danger cursor-pointer"><i class="ti ti-trash"></i></span>
                            </div>
                        </td>
                    </tr>
            ...
            $(document).on('change', '.main-type', function() {
                ...
                labels.forEach(label => {
                    ...
                    <tr>
                        <td>
                            <input type="text" name="label[]" class="form-control label-input" placeholder="Nhãn màu" value="${label}">
                        </td>
                        <td>
                            <div class="d-flex align-items-center gap-2">
                                <div id="${pickerId}" class="color-preview"> </div>
                    ...
                    <tr>
                        <td colspan="2">
                            <div class="d-flex justify-content-between align-items-center">
                                <input type="text" class="form-control label-input" name="label[]" placeholder="Nhập giá trị" value="${label}">
                                <span class="review-row-btn ms-2 text-danger cursor-pointer"><i class="ti ti-trash"></i></span>
                            </div>
                        </td>
                    </tr>
