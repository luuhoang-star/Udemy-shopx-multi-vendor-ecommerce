        ...
        <div class="accordion-body">
            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <input type="text" class="form-control" value="{{ $attribute->name }}" name="attribute_name" placeholder="VD: Màu sắc, Kích cỡ">
            ...
            <table class="table table-bordered section-table mt-3"
                ...
                <thead>
                    <tr>
                        <th>Nhãn hiển thị</th>
                        <th class="value-header">Giá trị màu</th>
                    </tr>
                </thead>
                <tbody>
                    ...
                    <tr>
                                <td>
                                    <input type="text" name="label[]" class="form-control label-input"
                                        placeholder="Nhãn (VD: Đỏ, Xanh)" value="{{ $value->value }}">
                                </td>
                                <td>
                    ...
                    <tr>
                        <td colspan="2">
                            <div class="d-flex justify-content-between align-items-center">
                                <input type="text" class="form-control label-input" name="label[]" placeholder="Nhập giá trị (VD: S, M, L, XL)" value="{{ $value->value }}">
                                <span class="review-row-btn ms-2 text-danger cursor-pointer"><i class="ti ti-trash"></i></span>
                            </div>
                        </td>
                    </tr>
