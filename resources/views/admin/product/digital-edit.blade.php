                ...
                <div class="col-md-8">
                    <div class="card mb-3">
                        <div class="card-body">
                            ...
                            <div class="col-md-12">
                                <div class="mb-3">
                                    <label class="form-label required">Tên sản phẩm số</label>
                                ...
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" name="sku"
                                            value="{{ $product->sku }}" placeholder="VD: SKU-DIGI-1001">
                    ...
                    <div class="card mt-3" id="product-images">
                        <div class="card-header">
                            <h3 class="card-title">Tập tin sản phẩm số (Files tải về)</h3>
                        </div>
                        <div class="card-body">
                            <div class="col-md-12">
                                <div class="mb-3">
                                    ...
                                    <div id="filePreviewContainer" class="file-preview-container">
                                        @foreach ($product->files ?? [] as $file)
                                            <div class="dz-preview dz-file-preview">
                                                ...
                                                <div class="dz-percentage"><span class="progress-text">Đã tải lên</div>
...
@push('scripts')
    ...
    <script>
        ...
        const fileUploader = new Dropzone("#fileUploader", {
            ...
            <div class="dz-percentage"><span class="progress-text">0</span>% Đã tải lên</div>
