...
@section('contents')
    <div class="container-fluid mt-4">
        <div class="row">
            <div class="col-md-4">
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        ...
                        <button class="btn btn-primary" id="btn-new">+ Thêm mới</button>
                    </div>
                    <div class="card-body">
            ...
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header"><span id="category-title" class="fw-bold">Thêm mới danh mục</span></div>
                    <div class="card-body">
                        <form action="" id="category-form">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="mb-2">
                                        <label for="" class="form-label">Biểu tượng (Icon)</label>
                            ...
                            <div class="mb-2">
                                ...
                                <input type="text" name="name" class="form-control" required id="name" placeholder="Nhập tên danh mục">
                            </div>
                            <div class="mb-2">
                                <label for="" class="form-label">Đường dẫn thân thiện (Slug) <span class="text-danger">*</span></label>
                                <input type="text" name="slug" class="form-control" required id="slug" placeholder="duong-dan-danh-muc">
                            </div>
                            <div class="mb-2">
                            ...
                            <div class="d-flex gap-2 mt-3">
                                <button type="submit" class="btn btn-primary" id="btn-save">Lưu thông tin</button>
                                <button type="button" class="btn btn-danger d-none" id="btn-delete">Xóa danh mục</button>
    ...
    <script>
        ...
        $(function() {
                ...
                categories.forEach(function(cat) {
                    html += `<li class="dd-item custom-cat-item" data-id="${cat.id}">
                                    <div class="dd-item-row custom-cat-row">
                                        <div class="dd-handle custom-cat-handle" title="Kéo để sắp xếp thứ tự">
            ...
            function loadParentDropdown(selectedId, excludeId) {
                $.get("{{ route('admin.categories.nested') }}", function(data) {
                    let options = '<option value="">Không có (Danh mục gốc)</option>';
            ...
            function fillForm(cat) {
                let domain = "{{ url('/') }}";
                $('#category-title').text('Chỉnh sửa danh mục');
                $('#name').val(cat.name);
                $('#slug').val(cat.slug);
            ...
            function clearForm() {
                ...
                $('#category-title').text('Thêm mới danh mục');
                $('#name').val('');
                $('#slug').val('');
                $('#parent_id').val('');
