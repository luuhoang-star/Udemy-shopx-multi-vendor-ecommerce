        ...
        <form action="" class="product-form">
            ...
            <div class="row">
                <div class="col-md-8">
                    ...
                    <div class="card mt-3" id="product-images">
                        <div class="card-header">
                            <h3 class="card-title">Tệp sản phẩm kỹ thuật số (File tải về)</h3>
                        </div>
                        <div class="card-body">
                            <div class="col-md-12">
                                <div class="mb-3">
                            ...
                            <div class="col-md-12">
                                <div class="mb-3">
                                    <select name="status" class="form-control" id="">
                                        ...
                                        <option @selected($product->status == 'pending') value="pending">Chờ xử lý (Pending)</option>
                                    </select>
                            ...
                            <div class="col-md-12">
                                <div class="mb-3">
                                    <select name="store" class="form-control select2" id="">
                                        <option value="published">-- Chọn gian hàng --</option>
