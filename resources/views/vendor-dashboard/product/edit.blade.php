        ...
        <form action="" class="product-form">
            ...
            <div class="row">
                <div class="col-md-8">
                    <div class="card mb-3">
                        <div class="card-body">
                            ...
                            <div class="col-md-12">
                                <div class="mb-3">
                                    <label class="form-label required">Mô tả ngắn gọn</label>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <label class="form-label">Khuyến mãi đến ngày</label>
                    ...
                    <div class="card mt-3" id="product-images">
                        <div class="card-header">
                            <h3 class="card-title">Biến thể / Phiên bản sản phẩm</h3>
                        </div>
                        <div class="card-body">
                            <div class="col-md-12">
                ...
                <div class="col-md-4">
                            ...
                            <div class="col-md-12">
                                <div class="mb-3">
                                    <select name="status" class="form-control" id="">
                                        <option @selected($product->status == 'active') value="active">Đang bán (Active)</option>
                                        <option @selected($product->status == 'inactive') value="inactive">Tạm ẩn (Inactive)</option>
                            ...
                            <div class="col-md-12">
                                <div class="mb-3">
                                    ...
                                    <label class="form-check">
                                        ...
                                        <span class="form-check-label">Hàng mới (New)</span>
                                    </label>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="card mb-3">
                        <div class="card-header">
                            <h3 class="card-title">Thẻ từ khóa (Tags)</h3>
                        </div>
                        <div class="card-body">
                            <div class="col-md-12">
                                <div class="mb-3">
                    ...
                    <div class="card mb-3" style="position: sticky; top: 0;">
                        ...
                        <div class="card-body">
                            <div class="col-md-12">
                                <div class="mb-3 row">
                                    <button class="btn btn-primary mt-3" type="submit">Lưu cập nhật</button>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="accordion-body">
            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <input type="text" class="form-control" value="" name="attribute_name" placeholder="Nhập tên thuộc tính...">
                </div>
                <div class="col-md-6">
            ...
            $(document).on('click', '.add-row-btn', function() {
                ...
                if (type === 'color') {
                    ...
                    <tr>
                        <td>
                            <input type="text" name="label[]" id="" class="form-control label-input" placeholder="Nhập tên màu...">
                        </td>
                        <td>
                    ...
                    <tr>
                        <td colspan="2">
                            <div class="d-flex justify-content-between align-items-center">
                                <input type="text" class="form-control label-input" name="label[]" placeholder="Nhập giá trị thuộc tính...">
                                <span class="review-row-btn ms-2 text-danger" style="cursor: pointer;"><i class="ti ti-trash"></i></span>
                            </div>
                        </td>
                    </tr>
