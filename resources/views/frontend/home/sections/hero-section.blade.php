                        ...
                        @foreach ($sliders as $slider)
                            <div class="single-hero-slider single-animation-wrap"
                                ...
                                <div class="slider-content">
                                    ...
                                    <a href="{{ $slider->btn_url }}" class="btn">Mua ngay <i
                    ...
                    <div class="col-12 col-md-6 col-lg-12">
                        <div class="banner-img style-4 mt-30">
                            ...
                            <div class="banner-text">
                                ...
                                <a href="{{ $heroBanner?->btn_url_one }}" class="btn btn-xs mb-50">Mua ngay <i
                                        class="fi-rs-arrow-small-right"></i></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-12 col-md-6 col-lg-12">
                        <div class="banner-img style-5 mt-5 mt-md-30">
                            ...
                            <div class="banner-text">
                                ...
                                <a href="{{ $heroBanner?->btn_url_two }}" class="btn btn-xs">Mua ngay <i
                                        class="fi-rs-arrow-small-right"></i></a>
                            </div>
                        </div>
                    </div>
