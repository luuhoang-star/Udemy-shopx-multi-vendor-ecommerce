...
@endphp
    <x-frontend.breadcrumb :items="[['label' => 'Trang chủ', 'url' => '/'], ['label' => 'Liên hệ']]" />
                                ...
                                <div class="row mb-60">
                                    ...
                                    <div class="col-md-4 mb-4 mb-md-0">
                                        <div class="contact_box">
                                            ...
                                            <p><b>Điện thoại:</b> {{ $contactSection?->phone_one ?? 'N/A' }}</p>
                                    ...
                                    <div class="col-md-4 mb-4 mb-md-0">
                                        <div class="contact_box">
                                            ...
                                            <p><b>Điện thoại:</b> {{ $contactSection?->phone_two ?? 'N/A' }}</p>
                                    ...
                                    <div class="col-md-4 mb-4 mb-md-0">
                                        <div class="contact_box">
                                            ...
                                            <p><b>Điện thoại:</b> {{ $contactSection?->phone_three ?? 'N/A' }}</p>
                                ...
                                <div class="row justify-content-center">
                                    <div class="col-xl-12">
                                        <div class="contact-from-area padding-20-row-col">
                                            <h5 class="text-brand mb-10">Biểu mẫu liên hệ</h5>
                                            <h2 class="mb-10">Gửi tin nhắn cho chúng tôi</h2>
                                            <p class="text-muted mb-30 font-sm">Địa chỉ email của bạn sẽ được bảo mật. Các trường bắt buộc được đánh dấu *</p>
                                            <form class="contact-form-style mt-30" id="contact-form" action="{{ route('contact.store') }}"
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="input-style mb-20">
                                                            <input name="subject" placeholder="Tiêu đề liên hệ *" type="text" />
                                                            <x-input-error :messages="$errors->get('subject')" class="mt-2" />
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-12 col-md-12">
                                                        <div class="textarea-style mb-30">
                                                            <textarea rows="6" name="message" placeholder="Nội dung tin nhắn *"></textarea>
