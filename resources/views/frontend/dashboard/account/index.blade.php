    ...
    <div id="account-detail" role="tabpanel" aria-labelledby="account-detail-tab">
        <div class="card">
            ...
            <div class="card-body p-0">
                <p>Bạn có thể cập nhật thông tin cá nhân của mình tại đây.</p>
        ...
        <div class="card mt-4">
            ...
            <div class="card-body p-0">
                <p>Cập nhật mật khẩu mới để bảo vệ an toàn cho tài khoản.</p>
                <form method="post" action="{{ route('password.update') }}">
                    ...
                    <div class="row mt-30">
                        ...
                        <div class="form-group col-md-12">
                            <label>Xác nhận lại mật khẩu mới <span class="required">*</span></label>
